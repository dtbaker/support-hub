...
//		echo '<pre>';echo $level;print_r($comments);echo '</pre>';
		...
		<div class="shub_message">
			<div class="shub_message_picture">
				...
				<img src="<?php echo $from->get_image() ? $from->get_image() : plugins_url('extensions/ucm/default-user.jpg',_DTBAKER_SUPPORT_HUB_CORE_FILE_);?>">
				<?php } ?>
			</div>
...
//				$ucm_data['comments'] = array_reverse($this->get_comments());
	...
	public function link_open(){
        return 'admin.php?page=support_hub_main&network=ucm&message_id='.$this->shub_ucm_message_id;
	}
