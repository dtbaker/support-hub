...
class shub_ucm extends SupportHub_extension {
	...
	public function get_friendly_icon(){
		return '<img src="'.plugins_url('extensions/ucm/ucm-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="shub_friendly_icon">';
	}
	...
	public function get_message_details($shub_message_id){
		...
		foreach($messages as $message){
			...
			$data['shub_column_account'] .= '<div><img src="'.plugins_url('extensions/ucm/ucm-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="ucm_icon small"><a href="'.$ucm_message->get_link().'" target="_blank">'.htmlspecialchars( $ucm_message->get('ucm_product') ? $ucm_message->get('ucm_product')->get( 'product_name' ) : 'Share' ) .'</a></div>';
			$data['shub_column_summary'] .= '<div><img src="'.plugins_url('extensions/ucm/ucm-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="ucm_icon small"><a href="'.$ucm_message->get_link().'" target="_blank">'.htmlspecialchars( $ucm_message->get_summary() ) .'</a></div>';
			...
			$data['shub_column_links'] .= '<div><img src="'.plugins_url('extensions/ucm/ucm-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="ucm_icon small">'. $link_clicks  .'</div>';
		}
		if(count($messages) && $link_clicks > 0){
			//$data['shub_column_links'] = '<div><img src="'.plugins_url('extensions/ucm/ucm-logo.png', _DTBAKER_SUPPORTHUB_CORE_FILE_).'" class="ucm_icon small">'. $link_clicks  .'</div>';
		}
		return $data;
	...
	public function output_row($message){
		...
		ob_start();
		?>
			<img src="<?php echo plugins_url('extensions/ucm/ucm-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_);?>" class="ucm_icon">
