...
if($current_account !== false){
	$shub_bbpress_account = $shub_bbpress->get_account($current_account);
    if($shub_bbpress_account->get('shub_extension') != 'bbpress')die('Wrong extension:' .$shub_bbpress_account->get('shub_extension'));
