...
class shub_google extends SupportHub_extension {
	...
	public function get_friendly_icon(){
		return '<img src="'.plugins_url('extensions/google/google-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="shub_friendly_icon">';
	}
	...
	public function page_assets($from_master=false){
		...
		wp_register_style( 'support-hub-google-css', plugins_url('extensions/google/shub_google.css',_DTBAKER_SUPPORT_HUB_CORE_FILE_) , array(), '1.0.0' );
		wp_enqueue_style( 'support-hub-google-css' );
		wp_register_script( 'support-hub-google', plugins_url('extensions/google/shub_google.js',_DTBAKER_SUPPORT_HUB_CORE_FILE_), array( 'jquery' ), '1.0.0' );
	...
	public function get_message_details($shub_message_id){
		...
		foreach($messages as $message){
			...
			$data['shub_column_account'] .= '<div><img src="'.plugins_url('extensions/google/google-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="google_icon small"><a href="'.$google_message->get_link().'" target="_blank">'.htmlspecialchars( $google_message->get('google_account')->get( 'account_name' ) ) .'</a></div>';
			$data['shub_column_summary'] .= '<div><img src="'.plugins_url('extensions/google/google-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="google_icon small"><a href="'.$google_message->get_link().'" target="_blank">'.htmlspecialchars( $google_message->get_summary() ) .'</a></div>';
			...
			$data['shub_column_links'] .= '<div><img src="'.plugins_url('extensions/google/google-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="google_icon small">'. $link_clicks  .'</div>';
		}
		if(count($messages) && $link_clicks > 0){
			//$data['shub_column_links'] = '<div><img src="'.plugins_url('extensions/google/google-logo.png', _DTBAKER_SUPPORTHUB_CORE_FILE_).'" class="google_icon small">'. $link_clicks  .'</div>';
		}
		return $data;
			...
			case 'modal':
				if(isset($_REQUEST['socialgooglemessageid']) && (int)$_REQUEST['socialgooglemessageid'] > 0) {
					...
					if($shub_google_message->get('shub_google_message_id') == $_REQUEST['socialgooglemessageid']){
						...
						include( trailingslashit( $support_hub_wp->dir ) . 'extensions/google/google_message.php');
					}
