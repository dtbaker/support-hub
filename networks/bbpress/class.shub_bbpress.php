...
class shub_bbpress extends SupportHub_network {
	...
	public function page_assets($from_master=false){
		...
		wp_register_style( 'support-hub-bbpress-css', plugins_url('networks/bbpress/shub_bbpress.css',_DTBAKER_SUPPORT_HUB_CORE_FILE_), array(), '1.0.0' );
		wp_enqueue_style( 'support-hub-bbpress-css' );
		wp_register_script( 'support-hub-bbpress', plugins_url('networks/bbpress/shub_bbpress.js',_DTBAKER_SUPPORT_HUB_CORE_FILE_), array( 'jquery' ), '1.0.0' );
	...
	public function get_message_details($shub_message_id){
		...
		foreach($messages as $message){
			...
			$data['shub_column_account'] .= '<div><img src="'.plugins_url('networks/bbpress/bbpress-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="bbpress_icon small"><a href="'.$bbpress_message->get_link().'" target="_blank">'.htmlspecialchars( $bbpress_message->get('bbpress_forum') ? $bbpress_message->get('bbpress_forum')->get( 'forum_name' ) : 'Share' ) .'</a></div>';
			$data['shub_column_summary'] .= '<div><img src="'.plugins_url('networks/bbpress/bbpress-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="bbpress_icon small"><a href="'.$bbpress_message->get_link().'" target="_blank">'.htmlspecialchars( $bbpress_message->get_summary() ) .'</a></div>';
			...
			$data['shub_column_links'] .= '<div><img src="'.plugins_url('networks/bbpress/bbpress-logo.png', _DTBAKER_SUPPORT_HUB_CORE_FILE_).'" class="bbpress_icon small">'. $link_clicks  .'</div>';
		}
		if(count($messages) && $link_clicks > 0){
			//$data['shub_column_links'] = '<div><img src="'.plugins_url('networks/bbpress/bbpress-logo.png', _DTBAKER_SUPPORTHUB_CORE_FILE_).'" class="bbpress_icon small">'. $link_clicks  .'</div>';
		}
		return $data;
